    ...
    return(
        <View style={styles.container}>
            <View style={styles.box}>
                ...
                {orders.map((item,i) => {
                    return(
                        <TouchableOpacity style={styles.card} key={i} onPress={() => {navigation.navigate('OrderDetails', {
                            _id : item._id, 
                            hookah : `${item.hookahSize}${item.hookahId}`, name : `${item.first_name} ${item.last_name }`, 
                            address : {house : item.houseNumber, street : item.street_name, area : item.area_name }})}}
                        >        
